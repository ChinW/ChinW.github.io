...
+function($) {
    ...
    var Header = function() {
        ...
        this.$menuBtn = $('#btn-open-menu');
        this.$menu = $('#menu-dialog');
        this.$cancelMenuBtn = $('#cancel-menu-btn');
        this.scrollTop;
    };
    ...
    Header.prototype = {
        ...
        run: function() {
            ...
            self.$menuBtn.click(function() {
                self.$menu.removeClass("hide");
            });

            self.$cancelMenuBtn.click(function() {
                self.$menu.addClass("hide");
            });
        },
